package project.shared_office_starter.service.auth;

import org.springframework.security.oauth2.server.resource.authentication.JwtAuthenticationToken;
import org.springframework.stereotype.Service;
import project.shared_office_common_lib.constant.JwtClaimKeysConstant;
import project.shared_office_starter.model.exception.PrincipalException;
...
public class PrincipalAuthService {
    public Map<String,Object> getPrincipalData(Principal principal) throws PrincipalException {
        ...
        String roleKey = JwtClaimKeysConstant.ROLE_KEY;
    ...
    private List<String> getRolesClaim(Principal principal) throws PrincipalException {
        return (List<String>) getClaim(principal, JwtClaimKeysConstant.ROLE_KEY);
    }
}
