package project.office_workforce_service.service.sync;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
import project.office_workforce_service.model.entity.User;
import project.office_workforce_service.model.entity.enums.UserRole;
...
public class UserSyncService {
    ...
    public User findByUidSync(String uid){
        ...
        User newUser = User.builder()
            .uid(uid)
            .roles(Set.of(UserRole.WORKFORCE_USER))
            .build();
