...
VALUES (1, 'admin_shield_001', CURRENT_TIMESTAMP);

INSERT INTO user_roles (user_id, role) 
VALUES (1, 'WORKFORCE_ADMIN');
...
VALUES (1, 'Shield Security Services Ltd.', '神盾保安服務有限公司', '12345678', 'admin@shieldsec.com', '+852 31234567', TRUE, 1);

INSERT INTO company_details (id, company_id, bio, address, industry, created_by)
VALUES (1, 1, 'Elite security guarding and patrol services.', '100 Security Tower, Wan Chai, HK', 'Security', 1);
...
VALUES (1, 1, 'Hong Kong Island Operations', 'Handles all high-security guarding on HK Island.', TRUE, 1);

-- 4. Create Places (The locations being guarded)
INSERT INTO places (id, org_id, name, address, is_active, created_by)
VALUES 
(1, 1, 'Central Bank Plaza', '1 Finance Street, Central', TRUE, 1),
(2, 1, 'Ocean View Residential', '88 Repulse Bay Road', TRUE, 1);

-- 5. Create Working Periods (Security Shifts)
INSERT INTO working_periods (id, org_id, start_at, end_at, name, is_active, created_by)
VALUES 
(1, 1, '08:00:00', '16:00:00', 'Day Shift', TRUE, 1),
(2, 1, '16:00:00', '00:00:00', 'Evening Shift', TRUE, 1),
(3, 1, '00:00:00', '08:00:00', 'Night Shift', TRUE, 1);

-- 6. Create Occupations (Guard Roles)
INSERT INTO occupations (id, org_id, name, is_active, created_by)
VALUES 
(1, 1, 'Senior Security Officer', TRUE, 1),
(2, 1, 'Patrol Guard', TRUE, 1),
(3, 1, 'CCTV Monitor', TRUE, 1);
...
VALUES 
(1, 'John Doe', '陳大文', '+852 91234561', 'john.doe@email.com', 'A123456(1)', TRUE, 1),
(2, 'Jane Smith', '李小玲', '+852 91234562', 'jane.s@email.com', 'B234567(2)', TRUE, 1),
(3, 'Bob Lee', '李博', '+852 91234563', 'bob.lee@email.com', 'C345678(3)', TRUE, 1);

INSERT INTO person_details (id, person_id, gender, nationality, created_by)
VALUES 
(1, 1, 'MALE', 'Hong Kong', 1),
(2, 2, 'FEMALE', 'Hong Kong', 1),
(3, 3, 'MALE', 'Hong Kong', 1);
...
VALUES 
(1, 1, 1, 1, 'STF-001', 'FULL_TIME', TRUE, 1), -- John
(2, 1, 2, 1, 'STF-002', 'PART_TIME', TRUE, 1), -- Jane
(3, 1, 3, 1, 'STF-003', 'FULL_TIME', TRUE, 1); -- Bob

INSERT INTO staff_details (id, staff_id, max_working_hrs, created_by)
VALUES 
(1, 1, 208, 1), -- John max 208 hrs/month
(2, 2, 100, 1), -- Jane max 100 hrs/month
(3, 3, 208, 1); -- Bob max 208 hrs/month

-- 9. Assign Roles to Staff (Staff Occupations)
INSERT INTO staff_occupations (id, staff_id, occupation_id, remark, created_by)
VALUES 
(1, 1, 1, 'Experienced team leader', 1), -- John is Senior Officer
(2, 2, 2, 'Excellent runner', 1),       -- Jane is Patrol Guard
(3, 3, 3, 'Eagle eyes', 1);             -- Bob is CCTV Monitor
...
VALUES (1, 1, 5, '{FULL_TIME, PART_TIME}'::work_type[], 1);
...
VALUES 
(1, CURRENT_DATE + INTERVAL '1 day 08:00:00', CURRENT_DATE + INTERVAL '1 day 16:00:00', 1, 1, 'DRAFT', 'System matched preference for John (Day Shift)', 1),
(2, CURRENT_DATE + INTERVAL '1 day 08:00:00', CURRENT_DATE + INTERVAL '1 day 16:00:00', 1, 2, 'DRAFT', 'System assigned Jane to fulfill 3-person requirement', 1);
