...
export function EntityPageLayout({ title, description, onAdd, children, searchPlaceholder, icon }: EntityPageLayoutProps) {
  return (
      ...
      <div className="bg-white border border-slate-200 rounded-xl shadow-sm flex-1 flex flex-col overflow-hidden">
        <div className="p-4 border-b border-slate-200 bg-slate-50/50 flex gap-4 items-center">
           <div className="relative flex-1 max-w-sm">
              ...
              <input type="text" placeholder={searchPlaceholder || "Search..."} className="w-full pl-9 pr-4 py-2 text-xs border border-slate-200 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500 bg-white shadow-sm" />
           </div>
        </div>
